...
class _ProductPageState extends State<ProductPage> {
  ...
  dottedSlider({required int maxHeight, required List<Widget> children}) {
    return dottedSlider(
      maxHeight: 200,
      children: <Widget>[
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Container(width: 130, child: const Text("Front Camera")),
                const SizedBox(
                  width: 48,
                ),
                const Text("16 MP"),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: <Widget>[
                Container(width: 130, child: const Text("Internal Storage")),
                const SizedBox(
                  width: 48,
                ),
                const Text("128 GB"),
            ...
            children: <Widget>[
              ...
              TrendingItem(
                product: Product(
                    ...
                    price: '\$3,890',
                    remainingQuantity: 5),
                gradientColors: [const Color(0XFF6eed8c), Colors.lightGreen],
              ),
              TrendingItem(
                product: Product(
                    company: 'Xiaomi',
